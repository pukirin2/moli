...
class ApiService {
  ...
  Future<BookingDetails> placeBooking({
    ...
    http.Response response = await http.post(Uri.parse(ConstRes.placeBooking),
        headers: {
          ConstRes.apiKey: ConstRes.apiKeyValue,
        },
        body: body);
