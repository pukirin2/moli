...
class AppRes {
  ...
  static DateTime parseDate(String dateTime,
      ...
      bool isUtc = true,
      String? locale}) {
    return DateFormat(pattern, locale).parse(dateTime, isUtc);
  }
  ...
  static String convertTimeForService(BuildContext context, int min) {
    if (min >= 60) {
      if (min == 60) {
        ...
        return '${min.minutes.inHours} ${AppLocalizations.of(context)!.hour} ${min.remainder(60)} ${AppLocalizations.of(context)!.min}';
      }
    } else {
